...
if __name__ == '__main__':
    ...
    #==========================================================================
        ...
        achievementsPackage = []
        ach1=Achievement(name='Starting Small',description='Purchase your first enclosure!',reward=100,code='ss')
        achievementsPackage.append(ach1)
        ach2=Achievement(name='Welcome To The Family',description='Purchase your first animal!',reward=100,code='wttf')
        achievementsPackage.append(ach2)
        ach3=Achievement(name='We Need More Space',description='Fill up your first enclosure!',reward=100,code='wnms')
        achievementsPackage.append(ach3)
        ach4=Achievement(name='Cash Collector',description='Have 5,000 in the bank at one time!',reward=1000,code='cc')
        achievementsPackage.append(ach4)
        ach5=Achievement(name='Cash Hoarder',description='Have 10,000 in the bank at one time!',reward=2500,code='ch')
        achievementsPackage.append(ach5)
        ach6=Achievement(name='Cash Savant',description='Have 32,000 in the bank at one time!',reward=1000,code='cs')
        achievementsPackage.append(ach6)
        ach7=Achievement(name='Fully Enclosed',description='Purchase all enclosures!',reward=32000,code='fe')
        achievementsPackage.append(ach7)
        ach8=Achievement(name='ZooOlogy',description='Purchase all enclosures and animals!',reward=100000000000,code='zoo')
